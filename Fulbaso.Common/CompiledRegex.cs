...
namespace Fulbaso.Common
{
    ...
    public static class CompiledRegex
    {
        ...
        public static readonly Regex WebLink = new Regex(Resources.Regex.WebLink, compiled);
        public static readonly Regex WwwSubdomain = new Regex(Resources.Regex.WwwSubdomain, compiled);
